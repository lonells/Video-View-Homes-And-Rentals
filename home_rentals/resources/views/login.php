...
<head>
    ...
    <link href="assets/css/glider.css" rel="stylesheet" type="text/css" />
...
section.submit-property select:-webkit-autofill:focus {
            ...
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                    <div class="sumbitpropertybox">
                        <form action="https://www.logodesignventure.com/project/admin/login" id="login_btn-send">
                            ...
                            <div class="loginuser w-100">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Enter Your Email*" required="" autocomplete="email" autofocus="">
                            </div>
                            ...
                            <!-- <a href="javascript:void(0);" data-fancybox data-animation-duration="700"
                                data-src="#animatedModal"><i class="fa fa-key " aria-hidden="true">Reset
                                    password</i></a> -->
                            <a href="register.php"><i class="" aria-hidden="true">Create New Account?</i></a>
                        </form>
                    </div>
                </div>
    ...
    <script src="assets/js/tkd_script.js"></script>
